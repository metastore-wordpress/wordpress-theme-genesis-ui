 ...
 * Genesis UI.
 *
 * This file adds the required helper functions used in the Genesis UI Theme.
 *
 * @package Genesis UI
 * @author  StudioPress
 * @license GPL-2.0+
 ...
 */
function genesis_ui_customizer_get_default_link_color() {
 ...
 */
function genesis_ui_customizer_get_default_accent_color() {
 ...
 */
function genesis_ui_color_contrast( $color ) {
 ...
 */
function genesis_ui_color_brightness( $color, $change ) {
