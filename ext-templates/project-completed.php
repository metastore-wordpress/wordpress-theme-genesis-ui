...
/**
 * Template Name:       Project / Catalog / Completed
...
function project_completed_loop() {
	...
	block_archive_description( 'Завершенные проекты', 'project' );
